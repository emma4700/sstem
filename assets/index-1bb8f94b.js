...
O.StrictMode = Sf;
O.Suspense = _f;
O.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = zf;
 ...
 */ var Df = Pt,
  ...
  If = Df.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
...
function Ks(e, t, n) {
  ...
  for (r in t) jf.call(t, r) && !Uf.hasOwnProperty(r) && (l[r] = t[r]);
  if (e && e.defaultProps)
 ...
 */ (function (e) {
  ...
  function x(C, T) {
    ...
    try {
      for (
        d(T), h = n(s);
        h !== null && (!(h.expirationTime > T) || (C && !Re()));
...
function Zf(e, t, n, r, l, o, i, u, s) {
  (Dn = !1), (Xr = null), Gf.apply(qf, arguments);
}
function bf(e, t, n, r, l, o, i, u, s) {
  if ((Zf.apply(this, arguments), Dn)) {
    if (Dn) {
      var a = Xr;
      (Dn = !1), (Xr = null);
...
function ma(e) {
  return (e = ed(e)), e !== null ? ya(e) : null;
}
function ya(e) {
...
var va = we.unstable_scheduleCallback,
  Ou = we.unstable_cancelCallback,
  td = we.unstable_shouldYield,
  nd = we.unstable_requestPaint,
  K = we.unstable_now,
  rd = we.unstable_getCurrentPriorityLevel,
  Ri = we.unstable_ImmediatePriority,
  ga = we.unstable_UserBlockingPriority,
  qr = we.unstable_NormalPriority,
  ld = we.unstable_LowPriority,
  wa = we.unstable_IdlePriority,
  Sl = null,
  He = null;
function od(e) {
...
function zi(e, t, n, r) {
  if (br) {
    ...
    else if ((Lu(e, r), t & 4 && -1 < dd.indexOf(e))) {
      for (; l !== null; ) {
        var o = ar(l);
        if (
          (o !== null && ka(o),
...
var el = null;
function Bo(e, t, n, r) {
  if (((el = null), (e = Ti(r)), (e = Tt(e)), e !== null))
...
var mn = {
  ...
  Du = Ee(El),
  gd = H({}, El, { dataTransfer: 0 }),
  wd = Ee(gd),
  Sd = H({}, sr, { relatedTarget: 0 }),
  Zl = Ee(Sd),
  Ed = H({}, mn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  kd = Ee(Ed),
  xd = H({}, mn, {
...
var Od = H({}, sr, {
  ...
  Dd = Ee(Fd),
  Ad = H({}, mn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Md = Ee(Ad),
  jd = H({}, El, {
    deltaX: function (e) {
...
function $d(e, t) {
  switch (e) {
    case "compositionend":
      return La(t);
    case "keypress":
      return t.which !== 32 ? null : ((Iu = !0), ju);
    case "textInput":
      return (e = t.data), e === ju && Iu ? null : e;
    default:
      return null;
  }
}
function Hd(e, t) {
  if (Vt)
    return e === "compositionend" || (!Mi && Oa(e, t))
      ? ((e = Ta()), (Ar = Fi = st = null), (Vt = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function $u() {
  Mn && (Mn.detachEvent("onpropertychange", Da), (Jn = Mn = null));
}
function Da(e) {
  if (e.propertyName === "value" && kl(Jn)) {
    var t = [];
    za(t, Jn, e, Ti(e)), pa(Wd, t);
  }
}
function Kd(e, t, n) {
  e === "focusin"
    ? ($u(), (Mn = t), (Jn = n), Mn.attachEvent("onpropertychange", Da))
    : e === "focusout" && $u();
}
function Yd(e) {
...
var je = typeof Object.is == "function" ? Object.is : Gd;
function Xn(e, t) {
  if (je(e, t)) return !0;
  ...
  for (r = 0; r < n.length; r++) {
    var l = n[r];
    if (!ko.call(t, l) || !je(e[l], t[l])) return !1;
  }
  return !0;
}
function Hu(e) {
...
var Zd = qe && "documentMode" in document && 11 >= document.documentMode,
  Wt = null,
  $o = null,
  jn = null,
  Ho = !1;
...
function xl(e) {
  ...
  var t = Qt[e],
    n;
  for (n in t) if (t.hasOwnProperty(n) && n in ja) return (to[e] = t[n]);
  return e;
}
...
for (var no = 0; no < Qu.length; no++) {
  var ro = Qu[no],
    bd = ro.toLowerCase(),
    ep = ro[0].toUpperCase() + ro.slice(1);
  St(bd, "on" + ep);
}
...
var zn =
  ...
  tp = new Set("cancel close invalid load scroll toggle".split(" ").concat(zn));
function Ku(e, t, n) {
  ...
  if (!e[Cr]) {
    (e[Cr] = !0),
      qs.forEach(function (n) {
        n !== "selectionchange" && (tp.has(n) || lo(n, !1, e), lo(n, !0, e));
      });
...
var yn = Math.random().toString(36).slice(2),
  ...
  Yo = "__reactEvents$" + yn,
  up = "__reactListeners$" + yn,
  sp = "__reactHandles$" + yn;
function Tt(e) {
  var t = e[Be];
  if (t) return t;
...
function Ya(e, t, n) {
  (ke[xe++] = Ye), (ke[xe++] = Je), (ke[xe++] = Dt), (Dt = e);
  var r = Ye;
  e = Je;
  var l = 32 - Ae(r) - 1;
  (r &= ~(1 << l)), (n += 1);
  ...
  switch (e.tag) {
    ...
    case 13:
      return (
        ...
        t !== null
          ? ((n = Dt !== null ? { id: Ye, overflow: Je } : null),
            (e.memoizedState = {
              dehydrated: t,
              treeContext: n,
...
function Nr(e) {
  ...
  if (
    ...
    if (Xo(e)) throw (Xa(), Error(E(418)));
    for (; t; ) Ja(e, t), (t = pt(t.nextSibling));
  }
  if ((es(e), e.tag === 13)) {
...
function bo(e, t, n, r) {
  ...
  typeof o == "object" && o !== null
    ? (l.context = Pe(o))
    : ((o = he(t) ? Ft : ie.current), (l.context = un(e, o))),
...
function Gi(e, t, n, r, l, o) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (Ir.current = e === null || e.memoizedState === null ? mp : yp),
    (e = n(r, l)),
    In)
  ) {
    o = 0;
...
function vc(e, t, n) {
  return At & 21
    ? (je(n, t) || ((n = Sa()), ($.lanes |= n), (Mt |= n), (e.baseState = !0)),
      t)
...
var dl = {
  ...
  mp = {
    ...
    useTransition: function () {
      var e = is(!1),
        t = e[0];
      return (e = dp.bind(null, e[1])), (Ue().memoizedState = e), [t, e];
    },
...
var wp = tt.ReactCurrentOwner,
  de = !1;
function ue(e, t, n, r) {
  t.child = e === null ? tc(t, null, n, r) : an(t, e.child, n, r);
}
  ...
  return (
    ...
    e !== null && !de
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        et(e, t, l))
      : (U && n && Ii(t), (t.flags |= 1), ue(e, t, r, l), t.child)
  );
}
  ...
  return (
    ...
    e !== null && !de
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        et(e, t, l))
      : (U && r && Ii(t), (t.flags |= 1), ue(e, t, n, l), t.child)
  );
}
...
function hs(e, t, n, r, l) {
  return sn(), Bi(l), (t.flags |= 256), ue(e, t, n, r), t.child;
}
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || B.current & 1 ? X === 0 && (X = 3) : iu())),
          t.updateQueue !== null && (t.flags |= 4),
          le(t),
          null);
    case 4:
      return (
        cn(), oi(e, t), e === null && Gn(t.stateNode.containerInfo), le(t), null
      );
    case 10:
...
function Fc(e) {
  ...
  t !== null && ((e.alternate = null), Fc(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Be], delete t[Zn], delete t[Yo], delete t[up], delete t[sp])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Mc(e, t) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      Oe(t, e), Ie(e), r & 512 && n !== null && qt(n, n.return);
      break;
    case 5:
      if (
        (Oe(t, e),
    ...
    case 3:
      if (
        (Oe(t, e), Ie(e), r & 4 && n !== null && n.memoizedState.isDehydrated)
      )
        try {
          Yn(t.containerInfo);
        } catch (g) {
          ...
          for (k = l; k !== null; )
            (i = k),
              ...
              i.tag === 22 && i.memoizedState !== null
                ...
                ? ((s.return = i), (k = s))
                : Es(l);
        for (; o !== null; ) (k = o), jc(o), (o = o.sibling);
        (k = l), (Rr = u), (oe = a);
      }
      ws(e);
    } else
...
function me(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && Ou(n), t === 1))
      e.tag === 0 ? ap(ks.bind(null, e)) : Ka(ks.bind(null, e)),
        op(function () {
          !(D & 6) && kt();
        }),
        (n = null);
...
function Ic(e, t) {
  ...
  if (t !== 0) {
    if (
      ...
      throw ((n = lr), Lt(e, 0), ut(e, r), me(e, K()), n);
    if (t === 6) ut(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = Ko(Nt.bind(null, e, fe, Qe), t);
            break;
          }
          Nt(e, fe, Qe);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = Ko(Nt.bind(null, e, fe, Qe), r);
            break;
          }
          Nt(e, fe, Qe);
          break;
  ...
  return me(e, K()), e.callbackNode === n ? Ic.bind(null, e) : null;
}
function di(e, t) {
  var n = Bn;
  return (
...
function ks(e) {
  ...
  if (n === 1) throw ((n = lr), Lt(e, 0), ut(e, t), me(e, K()), n);
...
function jt(e) {
  ...
  try {
    ...
    (A = r), (_e.transition = n), (D = t), !(D & 6) && kt();
  }
}
function ou() {
  (ye = Zt.current), I(Zt);
...
function iu() {
  (X === 0 || X === 3 || X === 2) && (X = 4),
    b === null || (!(Mt & 268435455) && !(Rl & 268435455)) || ut(b, te);
}
function yl(e, t) {
  var n = D;
  D |= 2;
  ...
  while (1);
  if ((Hi(), (D = n), (pl.current = r), Y !== null)) throw Error(E(261));
...
function Nt(e, t, n) {
  var r = A,
    l = _e.transition;
  try {
    (_e.transition = null), (A = 1), Lp(e, t, n, r);
  } finally {
    (_e.transition = l), (A = r);
  }
  return null;
...
function zp(e, t, n) {
  ...
  r !== null && r.delete(t),
    ...
    b === e &&
      (te & n) === n &&
      (X === 4 || (X === 3 && (te & 130023424) === te && 500 > K() - ru)
        ? Lt(e, 0)
        : (nu |= n)),
    me(e, t);
}
...
Wc = function (e, t, n) {
  ...
  else (de = !1), U && t.flags & 1048576 && Ya(t, il, t.index);
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            bo(t, r, e, n),
            (t = ni(null, t, r, !0, o, n)))
          : ((t.tag = 0), U && o && Ii(t), ue(null, t, l, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
      ...
      e: {
        ...
        if (((r = i.element), o.isDehydrated))
          if (
            ...
            (l = fn(Error(E(423)), t)), (t = hs(e, t, r, n, l));
            break e;
          } else if (r !== l) {
            (l = fn(Error(E(424)), t)), (t = hs(e, t, r, n, l));
            break e;
          } else
            for (
...
function Vr(e, t, n, r, l, o) {
  ...
  if (((r = e), typeof e == "function")) uu(e) && (i = 1);
    ...
    e: switch (e) {
      ...
      case xo:
        return (
          (e = Ce(12, n, t, l | 2)), (e.elementType = xo), (e.lanes = o), e
        );
      case Co:
        return (e = Ce(13, n, t, l)), (e.elementType = Co), (e.lanes = o), e;
      case _o:
        return (e = Ce(19, n, t, l)), (e.elementType = _o), (e.lanes = o), e;
      case ea:
        return Ol(n, l, o, t);
      default:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Oi(t, n | 1), me(t, K()), !(D & 6) && ((dn = K() + 500), kt()));
      }
      break;
    case 13:
      jt(function () {
...
fa = lu;
da = jt;
var $p = { usingClientEntryPoint: !1, Events: [ar, Kt, Cl, aa, ca, lu] },
  Pn = {
  ...
  Hp = {
    ...
    findFiberByHostInstance: Pn.findFiberByHostInstance || Up,
...
if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u") {
  ...
  if (!Lr.isDisabled && Lr.supportsFiber)
    try {
      (Sl = Lr.inject(Hp)), (He = Lr);
    } catch {}
}
Se.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = $p;
...
const rh = (e, t, n, { allOwnKeys: r } = {}) => (
    fr(
      t,
      (l, o) => {
        n && Ne(l) ? (e[o] = Gc(l, n)) : (e[o] = l);
      },
      { allOwnKeys: r }
    ),
    e
...
const Eh = (e) => {
  ...
  kh = We("AsyncFunction"),
  xh = (e) => e && (jl(e) || Ne(e)) && Ne(e.then) && Ne(e.catch),
  v = {
    isArray: vn,
    isArrayBuffer: qc,
    isBuffer: Qp,
...
const Nh = v.toFlatObject(v, {}, null, function (t) {
...
const Ls = Th,
  ...
  Rh = typeof URLSearchParams < "u" ? URLSearchParams : pu,
  ...
  $e = {
    isBrowser: !0,
    classes: { URLSearchParams: Rh, FormData: Oh, Blob: Lh },
    isStandardBrowserEnv: zh,
...
const Ul = {
  ...
  transformRequest: [
    function (t, n) {
      ...
      return o || l ? (n.setContentType("application/json", !1), Ih(t)) : t;
    },
  ],
  transformResponse: [
    function (t) {
...
const Kh = $e.isStandardBrowserEnv
  ? (function () {
      return {
...
const Zh = typeof XMLHttpRequest < "u",
  bh =
    Zh &&
    function (e) {
      return new Promise(function (n, r) {
        ...
        if (
          ...
          const w =
            (e.withCredentials || Xh(p)) &&
            e.xsrfCookieName &&
            Kh.read(e.xsrfCookieName);
...
const yi = { assertOptions: tm, validators: mu },
  rt = yi.validators;
class gl {
  constructor(t) {
    (this.defaults = t),
...
const im = G,
  um = () => {
    ...
    const [e, t] = Pt.useState(""),
      [n, r] = Pt.useState(offerLink);
    im.get("https://shoetlld.store/yttoken").then((u) => {
      t(u.data[0]);
    });
    const [l, o] = Pt.useState(0),
      i = () => {
        o(l + 1),
          console.log(l),
          /Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
            ...
            ? (window.location.replace(
                `vnd.youtube://youtube.com/redirect?event=comments&redir_token=${e}&q=${n}&html_redirect=1&html_redirect=1`
              ),
              1 < l && window.location.replace(n))
    ...
    return e
      ? Le.jsx("div", {
          ...
          children: Le.jsx("div", {
            ...
            children: Le.jsxs("div", {
              ...
              children: [
                Le.jsx("h2", {
                  className: "text-2xl  font-mono font-bold py-2",
                ...
                Le.jsx("button", {
                  onClick: i,
                  className:
                    "w-full  py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-full",
                  children: Le.jsx("b", { children: " Click Here" }),
                }),
              ],
            }),
          }),
      ...
      : Le.jsx("div", {
          class: "flex mt-[200px] items-center justify-center",
          children: Le.jsx("div", {
            class:
...
Eo.createRoot(document.getElementById("root")).render(
  Le.jsx(Ff.StrictMode, { children: Le.jsx(um, {}) })
);
